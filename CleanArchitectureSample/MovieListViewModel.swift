...
final class DefaultMoviesListViewModel: MoviesListViewModel {
    ...
    private func load(movieQuery: MovieQuery, loading: MoviesListViewModelLoading) {
        ...
        moviesLoadTask = searchMoviesUseCase.execute(requestValue: .init(query: movieQuery, page: nextPage), cached: { [weak self] page in
    ...
    private func handle(error: Error) {
        self.error.value = error.isInternetConnectionError ? NSLocalizedString("No Internet connection", comment: "") : NSLocalizedString("Failed loading movies", comment: "")
    }
